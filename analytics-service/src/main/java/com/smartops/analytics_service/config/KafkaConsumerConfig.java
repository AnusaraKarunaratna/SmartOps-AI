package com.smartops.analytics_service.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SaleEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, SaleEvent.class.getName());
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SaleEvent> kafkaListenerContainerFactory() {
